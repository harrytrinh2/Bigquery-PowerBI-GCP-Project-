--MUSIC
SELECT CMS_ID,TITLE,TIME_UPLOADED,TOTAL_VIEWS,RANK
FROM(
SELECT     CMS_ID,
    VIDEO_ID,
    TITLE,
    time_uploaded AS TIME_UPLOADED,
    TOTAL_VIEWS,
    ROW_NUMBER() OVER (PARTITION BY CMS_ID ORDER BY TOTAL_VIEWS DESC) as `RANK`
...
SELECT  
        ...
        t0.CMS_ID,
        CASE WHEN t0.time_published >='2018-10-19' THEN t0.time_published ELSE t0.time_uploaded END AS `time_uploaded`,
        t0.DATE, 
        t0.CHANNEL_ID,
        t1.EST_VIEWS,
        t0.TITLE
FROM
            ...
            WHERE DATE(_PARTITIONTIME) between "2018-10-19" and "2018-10-25" 
...
WHERE
    DATE BETWEEN "2018-10-19" and "2018-10-25"  and time_uploaded between "2018-10-19" and "2018-10-25" 
GROUP BY
    DATE,
    CMS_ID,    
    VIDEO_ID,
