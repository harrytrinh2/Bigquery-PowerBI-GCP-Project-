INSERT INTO `pops-204909.monthly_reports.top_20_channels_views` 
...
LEFT JOIN (SELECT DISTINCT CMS_ID, DATE FROM `pops-204909.monthly_reports.top_20_channels_views`) t1 on t0.CMS_ID = t1.CMS_ID and t0.DATE = t1.DATE